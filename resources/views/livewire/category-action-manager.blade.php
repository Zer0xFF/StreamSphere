<div class="max-w-4xl mx-auto py-10">
    ...
    <div x-data="{ open: false }" class="mb-6 bg-white p-6 rounded-lg shadow-md">
        <h3 class="text-lg font-semibold text-gray-700 mb-4 cursor-pointer" @click="open = !open">
            Filter Options
            <span x-show="!open">▼</span>
            <span x-show="open">▲</span>
        </h3>
        <div x-show="open" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                <label class="block text-gray-700 font-medium mb-2">Provider</label>
                <select wire:model.live="filter_provider_id" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                <label class="block text-gray-700 font-medium mb-2">Category Name</label>
                <input type="text" wire:model.live="filter_category_name" placeholder="Filter by Category Name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
                <label class="block text-gray-700 font-medium mb-2">Action</label>
                <input type="text" wire:model.live="filter_action" placeholder="Filter by Action" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
                <label class="block text-gray-700 font-medium mb-2">Is Hidden</label>
                <select wire:model.live="filter_is_hidden" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
